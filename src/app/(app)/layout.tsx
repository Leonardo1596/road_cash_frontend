...
import { DollarSign, Home, Settings, Wallet, LogOut, Loader2 } from 'lucide-react';
...
function UserNav() {
    ...
    return (
        <div className="flex items-center gap-2 p-2">
            ...
            <Button variant="ghost" size="icon" className="ml-auto group-data-[collapsible=icon]:ml-0" onClick={handleLogout}>
    ...
    <SidebarProvider>
      <Sidebar>
        <SidebarHeader>
            <Link href="/dashboard" className="flex items-center gap-2 font-headline text-lg font-semibold">
                ...
                <span className="group-data-[collapsible=icon]:hidden">RoadCash</span>
            </Link>
        </SidebarHeader>
        <SidebarContent>
            <MainNav />
      ...
      <SidebarInset>
        <header className="sticky top-0 z-10 flex h-16 items-center gap-4 border-b bg-background/80 backdrop-blur-sm px-4 md:px-6">
            ...
            <h1 className="font-headline text-xl font-semibold sm:text-2xl">{getPageTitle()}</h1>
        </header>
